...
const AuctionLoadingCard = () => {
  return (
    <div className="flex items-center justify-center borderGradient rounded-[20px] w-[282px] h-[422px]">
      <div className="flex flex-col items-center justify-center gap-3 w-[280px] h-[420px] p-4 bg-[#1F2045] rounded-[20px] shadow-lg animate-pulse">
        {/* Profile Image and User Details */}
        <div className="flex gap-4 h-[60px] mr-[80px] items-center">
          <div className="relative flex-initial rounded-full overflow-hidden bg-gray-400 w-9 h-9"></div>
        ...
        {/* Auction Image */}
        <div className="w-[230px] h-[230px] overflow-hidden rounded-lg bg-gray-400"></div>
        ...
        <div className="flex text-[14px] justify-between w-full">
          ...
          <div className="space-y-2 items-center text-center">
            <div className="h-10 bg-gray-400 rounded w-28"></div>
            <div className="flex font-light w-[110px] h-[40px] text-center justify-center items-center rounded-[5px] bg-gray-400"></div>
          </div>
        </div>
      </div>
    </div>
